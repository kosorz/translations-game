import { Home, Launch } from "grommet-icons";

export const germanEnglishConfig = {
  general: {
    value: [
      {
        german: "ab",
  ...
  homeAndSurroundings: {
    value: [
      ...
      {
        german: "Vorzimmer",
        english: "hall / anteroom",
      },
      {
        german: "Wandschrank",
        english: "wall cupboard",
      },
      {
        german: "Waschbecken",
        english: "washbasin",
      ...
      {
        german: "Zudecke",
        english: "quilt / eiderdown",
      },
    ],
    name: {
      german: 'Zuhause und Umgebung',
      english: 'Home and surroundings'
    },
    Icon: Home,
  },
};
